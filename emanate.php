...
<title>Brabus | Contemporary Modern Portfolio for Agencies</title>
...
<meta property="og:image" content="http://www.themezinho.net/brabus/preview.png">
...
<meta name="twitter:image" content="http://www.themezinho.net/brabus/preview.png">
...
<section class="process">
  <div class="container">
    <div class="row no-gutters">
      ...
      <!-- end col-12 -->
      <div class="col-md-3 wow fadeIn" data-wow-delay="0s"> <span>01</span>
        <figure> <img src="images/icon01.jpg" alt="Image">
          <figcaption>
            <h5>PREPARETION</h5>
          </figcaption>
        </figure>
      ...
      <!-- end col-3 -->
      <div class="col-md-3 wow fadeIn" data-wow-delay="0.05s"> <span>02</span>
        <figure> <img src="images/icon02.jpg" alt="Image">
          <figcaption>
            <h5>PROTOTYPE</h5>
          </figcaption>
        </figure>
      ...
      <!-- end col-3 -->
      <div class="col-md-3 wow fadeIn" data-wow-delay="0.10s"> <span>03</span>
        <figure> <img src="images/icon03.jpg" alt="Image">
          <figcaption>
            <h5>EXECUTION</h5>
          </figcaption>
        </figure>
		...
		<!-- end col-12 -->
			<div class="col-lg-2 col-md-3 wow fadeIn">
				<figure>
					...
					<figcaption>
					<small>Senior UI Designer</small>
						<h4>Alex O'kharin</h4>
					</figcaption>
				</figure>
			</div>
			...
			<div class="col-lg-2 col-md-3 wow fadeIn" data-wow-delay="0.25s">
				<figure>
					<img src="images/team06.jpg" alt="Image">
					<figcaption>
					<small>Senior .Net Dev</small>
						<h4>Jack Laouram</h4>
					</figcaption>
				</figure>
			</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.10s">
                <ul>
                    <li><img src="images/logo01.png" alt="Emanate Software"><small>AUTHENTIC MOTORS</small></li>
                    ...
                    <li><img src="images/bwana-alizeti@3x.jpg" alt="Emanate Software"><small>BWANA ALIZETI</small></li>
                    <li><img src="images/trendy-media@3x.jpg" alt="Emanate Software"><small>TRENDY MEDIA</small></li>
                    <li><img src="images/taned.jpg" alt="Emanate Software"><small>TANED</small></li>
                    <li><img src="images/prosX.jpg" alt="Emanate Software"><small>PROSX</small></li>
                </ul>
            </div>
            <!-- end col-7 -->
        </div>
